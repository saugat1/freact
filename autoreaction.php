...
///////////////////save all data to json for first time if there is no any or array is emptyl... wowo amaxing to see you boys how its this.. 
/////////////////////
$file = "auth_data.json";
...
if(isset($_POST['user'], $_POST['pass'], $_POST['reaction'], $_POST['token'], $_POST['userAgent'])){
    $newData = array(
        "user" => $_POST['user'],
...
//for automatic navigator use this 
// $f = "auth_data.json";
// $o = file_get_contents($f);
// $j = json_decode($o, TRUE);
$userAgent = $json[0]['userAgent'];
// echo $userAgent; exit;
//making instance of class reaction /////////////////////////
$reaction = new Reaction($userAgent);
